                        ...
                        <div className="flex-1 flex justify-center items-center px-20">
                            <div className="w-full max-w-lg md:max-w-xl" style={{ maxWidth: '100vw', minWidth: '300px' }}>
                                <div className="flex justify-left mb-6">
                                    <p className="text-2xl font-semibold">New Organization</p>
                                </div>
                                ...
                                <form className=" space-y-6 overflow-y-scroll max-h-[60vh]">
                                    ...
                                    <div className="pt-4 -mb-4">
                                        <Input type="text" value={newOrg.name} placeholder="Name" required onChange={(e) => handleInputChange('name', e.target.value)} />
                                        <Input type="text" value={newOrg.address} placeholder="Address" required onChange={(e) => handleInputChange('address', e.target.value)} />
                                        <Input type="number" value={newOrg.phone} placeholder="Phone" required onChange={(e) => handleInputChange('phone', e.target.value)} />
                                        <Input type="email" value={newOrg.email} placeholder="Email" required onChange={(e) => handleInputChange('email', e.target.value)} />
                                        <Input type="text" value={newOrg.website} placeholder="Website" required onChange={(e) => handleInputChange('website', e.target.value)} />
                                    </div>
                                    ...
                                    <div className="pb-6 -mt-5 ">
                                        ...
                                        <div className="flex items-center gap-x-10 py-3 border border-neutral-300 rounded-lg">
                                            {["Activ", "Inactiv"].map((roleOption) => (
                                                <div key={roleOption} className="flex items-center pl-3 gap-x-2">
                                                    <input
                                                        type="radio"
                                                        name="role"
                                                        value={roleOption === "Activ"
                                                            ? 'activ'
                                                            : "inactiv"
                                                        }
                                                        required
                                                        checked={newOrg.status === (roleOption === "Activ"
                                                            ? 'activ'
                                                            : "inactiv"
                                                        )}
                                    ...
                                    <div className="flex justify-end gap-5 py-6">
                                        ...
                                        <button onClick={handleNext} className=" bg-violet-500 text-white py-3 px-10 rounded-lg hover:shadow-lg">
                                            Next
                                        </button>
                                    </div>
                                </form>
