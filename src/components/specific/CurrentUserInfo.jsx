    ...
    return (
        <div className='flex' >
            ...
            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-neutral-500 ">
                <span className='font-medium text-white text-2xl'>{name[0]}</span>
            </div>
                    ...
                    <div className="h-3/4 w-3/5 bg-white border border-neutral-300 rounded-xl z-10 overflow-hidden">
                        ...
                        <div className="flex-1 flex justify-center items-center px-20">
                            <div className="w-full max-w-lg md:max-w-xl" style={{ maxWidth: '100vw', minWidth: '300px' }}>
                                ...
                                <form onSubmit={handleUpdateUserInfo} className=" space-y-6 overflow-y-scroll max-h-[60vh]">
                                    ...
                                    <div className="flex justify-end gap-5 py-6">
                                        <button onClick={closeUserInfo} className=" border border-neutral-300 text-black py-3 px-10 rounded-lg hover:shadow-lg">
                                            Cancel
                                        </button>
                                        <button type='submit' className=" bg-violet-500 text-white py-3 px-10 rounded-lg hover:shadow-lg">
                                            Update
                                        </button>
                                    </div>
