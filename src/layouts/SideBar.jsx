...
export default function SideBar({ isOrgs, setIsOrgs }) {
    return (
        <div className="flex flex-col h-screen bg-neutral-50 min-w-72">
            <p className="text-3xl font-semibold px-8 pt-8">Kloyz.io</p>

            {/* MAIN MENU */}
            <div className="flex-grow space-y-4 px-8 border-b-2">
